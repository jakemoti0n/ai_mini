...
시작하기
준비: gcloud auth application-default login으로 구글 인증

설정: bridge.py 상단에 본인의 project_id 입력

실행: python bridge.py (11434 포트 대기)

게임: 모드 설정에서 Provider를 Ollama, URL을 http://127.0.0.1:11434로 지정
